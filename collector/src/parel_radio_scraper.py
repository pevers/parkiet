...
class ParelRadioScraper:
    ...
    def scrape_all_pages(self, start_page: int = 1, end_page: int = 40, delay: float = 2.0):
        ...
        for page_num in range(start_page, end_page + 1):
            ...
            try:
                ...
                logger.info(f"Page {current_page}/{max_page}, found {len(episodes)} episodes")
    ...
    def download_episodes(self, episodes_file: str = "all_episodes.json", delay: float = 1.0) -> int:
    ...
    def load_episodes_from_file(self, episodes_file: str = "all_episodes.json") -> List[Dict]:
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default="data/hoorspelen/Parel Radio",
    ...
    if args.download_only:
        ...
        try:
            response = input("\nDo you want to download all episodes now? (y/n): ").strip().lower()
